...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "payment.usdt_direct_network_hint": "⚠️ 请务必选择 TRC20 网络，并严格按上方实际金额付款。",
        "payment.usdt_direct_qr_hint": "提示：二维码仅包含收款地址；付款金额请手动填写上方实际支付金额，到账后系统会自动发货。",
    ...
    "en": {
        ...
        "payment.usdt_direct_network_hint": "⚠️ Use the TRC20 network and pay the exact amount shown above.",
        "payment.usdt_direct_qr_hint": "Tip: the QR code contains only the receiving address. Enter the exact amount manually; delivery starts automatically after the payment is detected.",
